  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="w-[400px] shrink-0 flex flex-col border-r">
        ...
        {/* AI vibe box */}
        <div className="border-t px-4 py-4 shrink-0 space-y-2 bg-muted/20">
          {aiSummary && (
            <div className="rounded-md border border-primary/30 bg-primary/5 px-3 py-2 flex items-start gap-2 text-sm text-primary">
